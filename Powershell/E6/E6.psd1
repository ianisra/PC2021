#
# Manifiesto del módulo 'E6Wifi'
#
# Generado por Ángela Montoya, Ian Leija, Dariela Hurtado
#
# Generado el 09/09/2021
#

@{

# Módulo de script o archivo de módulo binario asociado con este manifiesto.
RootModule = 'E6Wifi.psm1'
...
GUID = '918e3d6b-4206-4f4a-9bbf-060502c5db37'

# Autor de este módulo.
Author = 'Ángela Montoya, Ian Leija, Dariela Hurtado'

# Compañía o proveedor de este módulo.
CompanyName = 'Desconocido'

# Instrucción de copyright de este módulo.
Copyright = '(c) 2021 Ángela Montoya, Ian Leija, Dariela Hurtado. Todos los derechos reservados.'

# Descripción de la funcionalidad proporcionada por este módulo.
Description = 'Módulo hecho para la actividad E6 acerca del wifi'
